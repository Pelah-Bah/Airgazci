   ...
   <div class="col-lg-12 grid-margin stretch-card">
     <div class="card">
         <div class="card-hearder" style="text-align:center">
             <h2>LISTE DE GAZ PRODUITS A AIRGAZ-CI</h2>
         </div>
       <div class="card-body" >
        <div style="text-align:right">
            <a href="{{url('/famille/create')}}" class=" btn btn-info btn-sm" title="Ajouter nouveau client" style="width:90px">Nouveau </a>
            <a href=" " class=" btn btn-success btn-sm" title="Imprimer la liste" style="width:90px">Imprimer </a>
            <a href="{{url('/famille')}} " class=" btn btn-danger btn-sm" title="Retour" style="width:90px">Retour </a>
        </div>
               ...
               <tr>
                 ...
                 <td>
                    <div style="text-align:right">
                        ...
                        <a href="{{url('/famille/'. $item->id .'/edit')}} " title="Edit Student" class=" btn btn-primary btn-sm" style="width:90px"> <i class="fa fa-eye" aria-hidden="true">Modifier</i> </a>
