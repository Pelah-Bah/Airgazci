                  ...
                  <table class="table table-striped">
                      ...
                      <tbody>
                          <tr>
                              ...
                              <td width="80px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bouteilles vide&nbsp;&nbsp;&nbsp;</td>
                              <td width="130px">
                                  <select name=""   style="width: 100px; height:1.4rem; padding: 0rem;" class="form-control">
                                      <option value="">&nbsp;</option>
                                  @foreach ($prodbouteillevides as $prodbouteillevides)
                                      <option onclick=" " id=" " value="{{ $prodbouteillevides['id'] }}"  name=" "> {{ $prodbouteillevides['numeroBouteilles'] }}</option>
                                  @endforeach
                                      <input type="text" id=" ">
                                  </select>
                              </td>
                              ...
                              <td width="72px">
                                  <a type="submit" value="" class="btn btn-primary btn-sm" style="width:70px" > Annuler</a>
                              </td>
