...
<table border="1" style="background-color:#e4edf5">
    <tr>
        <td colspan="3">
    ...
    <tr>
        <td style=" width: 0px; height:6.6rem; margin:0px; padding:0px">
            <table class="table table-striped">
                <thead>
                <tr>
                    <th> BOUTEILLES </th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td  style=" width: 0px; height:1.6rem; margin:0px; padding:0px">{{ $bout['numeroBouteilles'] }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td>&nbsp; </td>
                        <td>
